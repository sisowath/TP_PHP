	...
	<!--Work-Starts-Here-->
	 ...
	 <div class="container">
		<div class="gallery-content-head text-left">
			...
			Bonjour <?php echo $_SESSION['connected'].", vous etes admin"; ?><hr />
			<!-- Début menu d'administration -->
			<ul>
				<li><a href="admin.php?what=photo">G&eacute;rer les photos</a></li>
				<li><a href="admin.php?what=alert">G&eacute;rer les alertes</a></li>
